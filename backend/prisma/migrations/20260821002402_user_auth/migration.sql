...
INSERT INTO "new_Audit" ("analyzerErrorsJson", "criticalCount", "domain", "errorMessage", "finishedAt", "grade", "highCount", "id", "infoCount", "lowCount", "mediumCount", "rawResultsJson", "score", "startedAt", "status", "technologiesJson", "url") SELECT "analyzerErrorsJson", "criticalCount", "domain", "errorMessage", "finishedAt", "grade", "highCount", "id", "infoCount", "lowCount", "mediumCount", "rawResultsJson", "score", "startedAt", "status", "technologiesJson", "url" FROM "Audit";
DROP TABLE "Audit";
